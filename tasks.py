...
def create_study_tasks(topic_or_content: str):
    ...
    visualize_task = Task(
        description=(
            ...
            "1. Write valid, clean Mermaid.js syntax (e.g., 'graph TD\\n A[CPU] --> B[ALU]') that accurately blocks out and labels these concepts into a flowchart.\n"
            "CRITICAL: The 'Generate Concept Image' tool now strictly accepts Mermaid code! Do NOT write a natural language prompt. You MUST pass ONLY the raw Mermaid diagram syntax to the tool.\n"
            "2. Pass this Mermaid code to the 'Generate Concept Image' tool.\n"
